...
let evaluacionesOrdenadas = evaluaciones.sort((a, b) => new Date(a.fecha) - new Date(b.fecha));
let tareasOrdenadas = tareas.sort((a, b) => new Date(a.fechaLimite) - new Date(b.fechaLimite));
